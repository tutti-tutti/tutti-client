const ProductItemSkeleton = () => {
  return (
    <li className="py-lg md:py-7xl animate-pulse">
      ...
      <div className="my-xs h-4 w-1/3 rounded-md bg-gray-200" />

      <div className="mb-xs h-8 w-full rounded-md bg-gray-200" />
      ...
      <div className="mb-1 h-3 w-1/4 rounded-md bg-gray-200" />

      <div className="gap-2xs flex items-center">
        <div className="h-9 w-12 rounded-md bg-gray-200" />
