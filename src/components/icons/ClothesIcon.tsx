const ClothesIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        d="M0 14.2222C0 6.36751 6.36751 0 14.2222 0H49.7778C57.6325 0 64 6.36751 64 14.2222V49.7778C64 57.6325 57.6325 64 49.7778 64H14.2222C6.36751 64 0 57.6325 0 49.7778V14.2222Z"
        fill="#FBFAFF"
      />
      <path
        fillRule="evenodd"
